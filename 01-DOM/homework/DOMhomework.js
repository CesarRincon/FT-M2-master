...
// Usando querySelector seleccionar dicho span por su id ('') y luego usando innerHTML
// agregar tu nombre al final del texto actual. Ej: ''
// Tu código acá:
document.querySelector('#createdBy').innerHTML += ' César.';
...
//    2) Asignarle a 'toDoShell' la clase ''
...
//  3) Llamar a la función previemante creada '' pasándole como argumento el array toDoItems
...
function addToDo() {
  ...
  let nuevoToDo = new ToDo(toDoInput);
  if (toDoInput) {
    toDoItems.push(nuevoToDo);
    toDoInput = '';
    console.log('funciono', toDoItems);
  }
  else {
...
//   1) Seleccionar el elemento cuyo id es ''
